...
formCreateCategory.addEventListener("submit", function (e) { return __awaiter(_this, void 0, void 0, function () {
    var btnCreateCategory, form, statusCategory, nameCategory, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                e.preventDefault();
                btnCreateCategory = document.querySelector("#btn-create-category");
                btnCreateCategory.innerHTML = "<img src=\"/images/btn-loading.svg\" alt=\"btn-loading\" class=\"w-max m-auto\"/>";
                form = e.target;
                statusCategory = form.status.value;
                nameCategory = form.name.value;
                data = {
                    name: nameCategory,
